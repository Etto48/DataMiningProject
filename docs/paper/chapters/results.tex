...
Excluding \texttt{neural\_network-G0-6}, \\
\texttt{neural\_network-G1-0} and 
\texttt{neural\_network-G1-3}, the other neural
networks all learned to classify only a single
class in the validation set. This can be
